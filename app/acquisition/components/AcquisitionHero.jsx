    ...
    <section className="section-solid h-[75%] w-full relative flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-8 md:px-16">
        <div className="text-center max-w-3xl">
          {/* Main Heading */}
          <h1 className="text-text-dim text-3xl md:text-4xl lg:text-5xl font-bold tracking-wide mb-2">
            ACQUISITIONS  &
          </h1>
          <h2 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold tracking-wide mb-8">
            PARTNERSHIPS
          </h2>
