...
const WhyChooseSlider = () => {
  ...
  return (
    <section className="section-solid w-full py-20">
      {/* Section Heading */}
      <h2 className="text-white text-sm tracking-[0.2em] uppercase mb-12 px-8 md:px-16">
        WHY CHOOSE COMPELL?
      </h2>
      ...
      >
        <div className="flex gap-6 px-8 md:px-16" style={{ width: 'max-content' }}>
          {slides.map((slide) => (
            <div key={slide.id} className="flex flex-col w-[350px] md:w-[400px] flex-shrink-0 bg-[#070101] rounded-md pb-4">
              {/* Slide Image */}
              ...
              {/* Slide Caption */}
              <p className="text-text-dim text-sm md:text-base mt-4 h-fit leading-relaxed ml-3">
                {slide.caption}
              </p>
            </div>
          ))}
